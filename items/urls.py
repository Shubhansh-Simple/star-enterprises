...
# local
from .views import CurrentStockListView, ItemsListView, ItemsCreateView, ItemsUpdateView, ItemsDeleteView
...
urlpatterns = [
    ...
    # CRUD of canteen items including non-active items ( ONLY BY ADIL & ADMIN )
